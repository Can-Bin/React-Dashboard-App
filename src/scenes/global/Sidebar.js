...
import {Box, IconButton, Typograpghy, Typography, useTheme} from "@mui/material";
...
import MenuOutlinedIcon from '@mui/icons-materialMenuOutlined';
import MapOutlinedIcon from '@mui/icons-materialMapOutlined';
      ...
      {!isCollapsed && (
        <Box mb="25px">
          <Box display="flex" justifyContent="center" alignItems="center">
            <img src={user} alt="profile-user" width="100px" height="100px" style={{cursor: "pointer", borderRadius: "50%"}}  />
          </Box>
          <Box textAlign="center">
            <Typograpghy variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{m: "10px 0 0 0"}}>Can Bin</Typograpghy>
            <Typograpghy variant="h5" color={colors.greenAccent[500]}>Frontend Developer</Typograpghy>
          </Box>
        </Box>
      )}

            ...
            {!isCollapsed && (
              <Box mb="25px">
                ...
                <Box textAlign="center">
                  <Typography variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{m: "10px 0 0 0"}}>Can Bin</Typography>
                  <Typography variant="h5" color={colors.blueAccent[500]}>Frontend Developer</Typography>
                </Box>
              </Box>
            )}
